...
export function CheatSheet() {
  ...
  const cards = useMemo(
    () =>
      active === "All"
        ? cheatSheet
        : cheatSheet.filter((c) => c.category === active),
    [active],
  );
    ...
    <div className="mx-auto max-w-5xl">
      <div className="mb-8">
        ...
        <p className="mt-3 max-w-2xl text-pretty leading-relaxed text-muted-foreground">
          Every decision parameter, transformation matrix, and step sequence you
          need, rendered in clean mathematical notation. Ideal for last-minute
          revision.
        </p>
      </div>
